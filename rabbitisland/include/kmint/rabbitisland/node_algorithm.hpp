#ifndef RABBITISLAND_NODE_ALGORITHM_HPP
#define RABBITISLAND_NODE_ALGORITHM_HPP
...
///
map::map_node const &find_dog_resting_place(map::map_graph const &graph);
...
#endif /* RABBITISLAND_NODE_ALGORITHM_HPP */
