...
int main() {
  ...
  s.build_actor<rabbitisland::dog>(graph,
      rabbitisland::find_node_of_kind(graph, '1'));
  s.build_actor<rabbitisland::mister>(graph,
      rabbitisland::find_node_of_kind(graph, '2'));
  s.build_actor<rabbitisland::misses>(graph,
      rabbitisland::find_node_of_kind(graph, '3'));
