...
constexpr const char *waterGraphDescription = R"graph(32 24 32
resources/rabbitisland.png
W 1 1
H 0 0
M 0 0
...
constexpr const char *grassGraphDescription = R"graph(32 24 32
resources/rabbitisland.png
W 0 0
H 0 0
M 0 0
...
constexpr const char *holesGraphDescription = R"graph(32 24 32
resources/rabbitisland.png
W 0 0
H 1 1
M 0 0
...
map::map WaterMap() { return map::read_map(waterGraphDescription); }
map::map GrassMap() { return map::read_map(grassGraphDescription); }
map::map HolesMap() { return map::read_map(holesGraphDescription); }
